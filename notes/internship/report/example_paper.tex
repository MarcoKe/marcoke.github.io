...
\subsection{Additional plots for section \ref{cifarclass}}
\begin{figure}[H]
      \centering
	...
	\includegraphics[width=0.5\textwidth,height=5cm,keepaspectratio]{img/appendix/cifarclass/trainlossma.png}
            ...
            \caption{CIFAR-10 classification as seen in section \ref{cifarclass}. From top to bottom: test set accuracy, training set loss, training set accuracy, training set loss with a moving average filter (window size 100). }
